  ...
  return (
    <footer className="bg-[#ffffff] text-[#000000] font-pop mt-5">
      <div className="w-11/12 max-w-6xl mx-auto py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
        {/* About Section */}
        <div>
          <h2 className="text-2xl font-bold text-[#000000] mb-3">TRENDZONE</h2>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mb-3">Phone: +8801940686844</p>
          <div className="flex gap-3 mt-3">
            <a
              href="#"
              className="bg-[#000000] text-[#ffffff] hover:bg-white hover:text-[#000000] transition p-2 rounded-full"
            >
              <FaFacebookF />
            </a>
            <a
